...
const CreateItinerary = () => {
    ...
    const handleEnterKey = (event: React.KeyboardEvent<HTMLInputElement | HTMLTextAreaElement>) => {
        if (event.key === 'Enter') {
    ...
    try {
      const response = await fetch('/api/create-itinerary', { // need to update endpoints
        method: 'POST',
        headers: {
